#include "co_zzyun_wsocks_UdpUtil.h"
...
JNIEXPORT jlong JNICALL Java_co_zzyun_wsocks_UdpUtil_initRaw
        (JNIEnv* env, jclass obj, jstring jfake_ip,jint fake_port, jstring jremote_ip, jint remote_port){
...
JNIEXPORT void JNICALL Java_co_zzyun_wsocks_UdpUtil_sendUdp(JNIEnv * env, jclass obj, jlong info, jbyteArray array,jint buf_len){
